...
SPELL_SCHOOL_BY_ID = {
    ...
    "soul_pulse": "soul",
    "soul_spark": "soul",
    "wound_gangrene": "biomancy",
    "nerve_cut": "biomancy",
    "organ_collapse": "biomancy",
    "keen_cut": "shadow",
    "shadow_carapace": "shadow",
    "shadow_execution": "shadow",
    "mind_cascade": "psionics",
    "mind_storm": "psionics",
    "rune_binding": "forbidden_runes",
    "rune_collapse": "forbidden_runes",
    "entropy": "chaos",
    "overload": "chaos",
    "bound_chaos": "chaos",
    "chaos_discharge": "chaos",
    "dampened_eruption": "chaos",
    "annihilation": "chaos",
    "soul_ward": "soul",
    "soul_resonance": "soul",
    "soul_migration": "soul",
...
SCHOOL_PROMPTS = {
    "biomancy": {
        ...
        "spells": {
            ...
            "wound_gangrene": {
                "name": "Wundbrand",
                "motif": "Open wound shape with one dark necrotic patch at its edge.",
                "remove": "fine skin texture, blood drops, background gore, multiple patches",
                "keep": "clear wound silhouette, one necrotic accent patch",
            },
            "nerve_cut": {
                "name": "Nervenschnitt",
                "motif": "Small blade cutting through one thick glowing nerve line.",
                "remove": "multiple strands, sparks, background muscle",
                "keep": "blade shape, one nerve line accent",
            },
            "organ_collapse": {
                "name": "Organkollaps",
                "motif": "Heart silhouette caved inward with one bold dark crack through the center.",
                "remove": "vein web, multiple cracks, blood drops",
                "keep": "caved organ silhouette, one bold crack",
            },
        },
    },
    "shadow": {
        ...
        "spells": {
            ...
            "keen_cut": {
                ...
                "motif": "Two crossing shadow blade strokes forming a bold X, one silver glint at the center.",
                "remove": "extra slash trails, mist particles, fine notches",
                "keep": "X-cut silhouette, one glint accent",
            },
            "shadow_carapace": {
                "name": "Schattenpanzer",
                "motif": "Layered dark carapace plates over a fist shape, one silver edge highlight.",
                "remove": "fine plate seams, background mist, extra highlights",
                "keep": "carapace silhouette, one edge highlight",
            },
            "shadow_execution": {
                "name": "Hinrichtung",
                "motif": "One large raised shadow blade, one thin silver edge gleam along its length.",
                "remove": "target reticle, motion trail layers, extra blades",
                "keep": "single raised blade silhouette, one edge gleam",
            },
        },
    },
    "psionics": {
        ...
        "spells": {
            ...
            "mind_cascade": {
                ...
                "motif": "Three descending glowing steps forming one cascade shape, brightest step as the accent.",
                "remove": "extra wave layers, spark particles, fine gradient bands",
                "keep": "cascade silhouette, one bright accent step",
            },
            "mind_storm": {
                "name": "Geistessturm",
                "motif": "One swirling storm vortex shape with a single bright bolt striking its center.",
                "remove": "multiple bolts, particle field, fine spiral filigree",
                "keep": "vortex silhouette, one bolt accent",
            },
        },
    },
    "forbidden_runes": {
        ...
        "spells": {
            ...
            "rune_binding": {
                "name": "Runenbindung",
                "motif": "Five small rune stones forming one closed ring silhouette, one glowing link line as the accent.",
                "remove": "extra runes, particle ring, fine glyph filigree",
                "keep": "closed ring shape, one link-line accent",
            },
            "rune_collapse": {
                "name": "Runenkollaps",
                "motif": "Rune ring collapsing inward into one bright piercing shard breaking through the center.",
                "remove": "many fragments, dust cloud, fine glyph detail",
                "keep": "collapsing ring silhouette, one piercing shard accent",
            },
        },
    },
    "chaos": {
        ...
        "spells": {
            ...
            "entropy": {
                "name": "Entropie",
                "motif": "One hexagon shape crumbling at one edge into a few green fragments.",
                "remove": "many fragments, dust haze, fine crack network",
                "keep": "hexagon silhouette, crumbling edge accent",
            },
            "overload": {
                "name": "Überladung",
                "motif": "One small cracked energy core with a few bold rays bursting from it.",
                "remove": "many rays, particle haze, fine surface texture",
                "keep": "core silhouette, burst-ray accent",
            },
            "bound_chaos": {
                "name": "Gezügeltes Chaos",
                "motif": "One jagged energy shape contained inside a simple ring, tension at the ring's edge as the accent.",
                "remove": "many tendrils, spark particles, fine ring detail",
                "keep": "contained-energy silhouette, ring accent",
            },
            "chaos_discharge": {
                "name": "Chaosentladung",
                "motif": "One bold discharge bolt shaped like a piercing spear, sharp tip as the accent.",
                "remove": "branching bolts, particle trail, fine edge noise",
                "keep": "single bolt silhouette, sharp-tip accent",
            },
            "dampened_eruption": {
                "name": "Gedämpfte Eruption",
                "motif": "One small contained eruption shape pressing against a dim restraining ring.",
                "remove": "full explosion rays, particle debris, fine flame filaments",
                "keep": "eruption silhouette, restraining-ring accent",
            },
            "annihilation": {
                "name": "Vernichtung",
                "motif": "One massive solid burst silhouette with a single bright white-hot core accent.",
                "remove": "secondary rays, fine flame filaments, orange accents, particle debris",
                "keep": "burst silhouette, bright core accent",
            },
        },
    },
    "soul": {
        ...
        "spells": {
            ...
            "soul_ward": {
                "name": "Seelenwache",
                "motif": "One soul orb shape with a single watchful eye-glint accent at its center.",
                "remove": "extra eyes, particle aura, fine wisp trails",
                "keep": "orb silhouette, eye-glint accent",
            },
            "soul_resonance": {
                "name": "Seelenresonanz",
                "motif": "Two overlapping ring shapes, one pale and one faintly tinted as the accent ring.",
                "remove": "nested rings, fine gradient bands, spark dots",
                "keep": "two-ring silhouette, tinted-ring accent",
            },
            "soul_migration": {
                "name": "Seelenwanderung",
                "motif": "One central soul orb with a single small orbiting mote as the accent.",
                "remove": "particle trails, multiple motes, fine orbit lines",
                "keep": "orb silhouette, one orbiting-mote accent",
            },
            "soul_fusion": {
                "name": "Seelenverschmelzung",
                "motif": "Two fused half-shapes forming one orb, one pale half and one faintly red-tinted half as the accent.",
                "remove": "fine crack network, particle haze, extra seams",
                "keep": "fused orb silhouette, tinted-half accent",
            },
            "soul_apotheosis": {
